...
function Edit({
  ...
  const responsivePanelBefore = {
    fn: ({
      ...
      return _abstracts_constants__WEBPACK_IMPORTED_MODULE_9__.FLEX_CSS_PROPS.map(props => (0,_commons_ResponsivePanel__WEBPACK_IMPORTED_MODULE_8__.responsivePanelControls)({
        stylesClasses,
        setAttributes,
        size,
        col: 6,
