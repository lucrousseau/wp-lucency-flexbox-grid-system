...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./block.json */ "./src/container/block.json");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./editor.scss */ "./src/container/editor.scss");
...
function Edit({
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)({
    className: (0,_commons_ResponsivePanel__WEBPACK_IMPORTED_MODULE_6__.updateClasses)({
      stylesClasses
    }, classnames__WEBPACK_IMPORTED_MODULE_1___default()("container lucency lucency-flex"))
  });
  ...
  const responsivePanelBefore = {
    fn: ({
      ...
      const controls = (0,_abstracts_constants__WEBPACK_IMPORTED_MODULE_7__.FLEX_CSS_PROPS)();
      delete controls.display;
      delete controls["flex-wrap"];
      delete controls.gap;
      return Object.entries(controls).map(([prop, props]) => (0,_commons_ResponsivePanel__WEBPACK_IMPORTED_MODULE_6__.responsivePanelControls)({
        stylesClasses,
        setAttributes,
        size,
        col: 6,
...
function save({
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
    className: (0,_commons_ResponsivePanel__WEBPACK_IMPORTED_MODULE_3__.updateClasses)({
      stylesClasses
    }, classnames__WEBPACK_IMPORTED_MODULE_1___default()("container container lucency lucency-flex"))
  });
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"lucency-grid/container","version":"1.0.0","title":"Container","category":"design","description":"Create a container to add all other components.","example":{"innerBlocks":[{"name":"core/heading","attributes":{"level":1,"content":"Title"}},{"name":"lucency-grid/row","innerBlocks":[{"name":"lucency-grid/column","innerBlocks":[{"name":"core/paragraph","attributes":{"content":"Lorem ipsum dolor sit amet..."}}]},{"name":"lucency-grid/column","innerBlocks":[{"name":"core/paragraph","attributes":{"content":"Lorem ipsum dolor sit amet..."}}]}]}]},"supports":{"html":false},"parent":[null],"textdomain":"lucency","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","attributes":{"stylesClasses":{"type":"object","default":{"full":{"variables":{"padding-top":4,"padding-right":2,"padding-bottom":4,"padding-left":2}}}}}}');
